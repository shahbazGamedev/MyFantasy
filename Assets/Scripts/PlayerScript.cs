/* Player Script Version 0.1 as of 21st November 2015
 * 
 * Script create and maintained by: Daniel Nelson
 * 
 * */
using UnityEngine;
...
public class PlayerScript : MonoBehaviour {
	...
	// Variables for weapon mangement 
	...
	// Variables for Stat System and Leveling
	public int str;
	public int intel;
	public int vit;
	public int def;
	...
	void Start () {
		...
		def = 5;
		hasLeveled = false;
		pointsToAdd = 10;	// Remove on Release
	...
	void Update () {
        ...
        if (Physics.Raycast(ray, out hit))
        {
			...
			if(Input.GetKeyDown(KeyCode.H))
			{
				...
				currentWeapon.GetComponent<Rigidbody>().AddForce(Vector3.forward * 2 * Time.deltaTime);
			}
        }
	}
